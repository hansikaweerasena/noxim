...
SC_MODULE(ProcessingElement)
{
    ...
    bool canShot(Packet & red_packet, Packet & blue_packet);	// True when the packet must be shot
    ...
    GlobalTraceInjector *trace_injector;	// Reference to the Global trace injector
